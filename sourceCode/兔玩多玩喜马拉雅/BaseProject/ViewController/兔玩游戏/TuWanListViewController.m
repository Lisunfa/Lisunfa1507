...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.iconimageView setImageWithURL:[self.tuwanVM iconURLForRowInList:indexPath.row] placeholderImage:[UIImage imageNamed:@"bg_focusImage_loading"]];
    cell.titleLabel.text = [self.tuwanVM titleForRowInList:indexPath.row];
    cell.longTitleLabel.text = [self.tuwanVM descForRowInList:indexPath.row];
    cell.clickNumLabel.text = [self.tuwanVM clicksForRowInList:indexPath.row];
